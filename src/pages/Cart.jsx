...
const Cart = () => {
  ...
  // Sample cart items for visual purposes
  const mockItems = [
    { id: 1, name: 'Casual T-Shirt', price: 29.99, quantity: 1, image: 'https://m.media-amazon.com/images/I/51IX0pMLGDL._AC_UY1000_.jpg' },
    { id: 2, name: 'Vintage Denim Shirt', price: 49.99, quantity: 2, image: 'https://images.unsplash.com/photo-1607349913338-fca6f7fc42d0?q=80&w=300&auto=format&fit=crop' },
  ];
        ...
        >
          ...
          >
            <motion.button
              ...
              onClick={ ()=>navigate('/') } // Example action to hide cart
            >
              <IoArrowBack />
            </motion.button>
            ...
            >
              <p className="text-xl sm:text-2xl font-bold text-white">
                Total: ${mockItems.reduce((sum, item) => sum + item.price * item.quantity, 0).toFixed(2)}
              </p>
              <motion.button
